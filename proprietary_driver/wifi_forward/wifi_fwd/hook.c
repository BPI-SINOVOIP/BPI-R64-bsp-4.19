...
void (*wf_fwd_set_debug_level_hook) (unsigned char level) = NULL;
...
void (*wf_fwd_bpdu_active_hook) (void) = NULL;
void (*wf_fwd_bpdu_halt_hook) (void) = NULL;
...
void (*wf_fwd_set_easy_setup_mode) (unsigned int easy_setup_mode) = NULL;
...
EXPORT_SYMBOL(wf_fwd_set_debug_level_hook);
...
EXPORT_SYMBOL(wf_fwd_bpdu_active_hook);
EXPORT_SYMBOL(wf_fwd_bpdu_halt_hook);
...
EXPORT_SYMBOL(wf_fwd_set_easy_setup_mode);
