...
struct wifi_fwd_func_table {
	...
	void (*wf_fwd_feedback_peer_adapter) (void *adapter, void *peer);
	void (*wf_fwd_feedback_map_table) (void *adapter, void *peer, void *opp_peer);
